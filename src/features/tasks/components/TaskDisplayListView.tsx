...
export const TaskDisplayListView = React.memo(function TaskDisplayListView({
  ...
  filters,
  isUpdating,
  pendingStatusId: _pendingStatusId,
  onEdit,
  onDelete,
  onStatusChange,
  onStart,
  onSchedule,
  onAddChecklist: _onAddChecklist,
  onEditChecklistItem,
  onDeleteChecklistItem,
  onChecklistItemStatusChange: _onChecklistItemStatusChange,
  onChecklistItemOpenStatusModal,
  onChecklistItemReorder: _onChecklistItemReorder,
  isChecklistItemUpdating: _isChecklistItemUpdating,
  onCreateTask,
